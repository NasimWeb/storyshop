...
export default function Topbar({isShowSidebar , setIsShowSidebar}) {
  ...
  return (
    ...
    >
      ...
      {location.pathname === "/" ? (
        <div className="date sticky top-[var(--header-height)] z-[9] flex flex-wrap justify-between gap-4 border-b border-zinc-300/25 bg-white/75  py-4 backdrop-blur-md dark:border-zinc-800/50 dark:bg-zinc-900/75 dark:text-white">
          <div
